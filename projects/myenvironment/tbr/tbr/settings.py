...
SECRET_KEY = '@_#9ay**_ib0#+etya_xvud%$6$is4s2lg+45e1ww+q#b38&6n'
...
INSTALLED_APPS = [
    ...
    'shop', #added in course 5
    'search_app', # added in course 16
    'cart',  #added in course 17
    'strip', #added in course 19
    'order', #added in course 20
    'crispy_forms', #add in course 22
    'main',
...
EMAIL_PORT = '587'
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'tbrtbrinfo@gmail.com'
